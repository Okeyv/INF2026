...
# 13 задание ЕГЭ. Организация компьютерных сетей. (IP,Адресс сети,маски)

# ------------------------------------------------------------------

# from ipaddress import *

## strict=False позволяет передать адрес узла вместо адреса сети
# ipnet = ip_network("146.180.173.153/255.192.0.0", strict=False)

# print(f"Адрес сети: {ipnet.network_address}")
# print(f"Широковещательный адрес: {ipnet.broadcast_address}")
# print(f"Количество доступных адресов: {ipnet.num_addresses - 2}")
